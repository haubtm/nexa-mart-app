...
export interface IProductDetailResponse
  extends IResponse<IProductDetailResponseData> {}

export interface IProductByBarcodeRequest {
  barcode: string;
}

export interface IProductByBarcodeResponse
  extends IResponse<{
    id: number;
    code: string;
    name: string;
